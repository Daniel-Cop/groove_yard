...
{
    #[Route('/', name: 'user_collection', methods: ['GET'])]
    ...
    #[Route('/add/{id}', name: 'user_collection_add', methods: ['GET', 'POST'])]
    ...
    #[Route('/edit/{id}', name: 'user_collection_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/delete/{id}', name: 'user_collection_delete', methods: ['POST'])]
